...
public class ApprovalController {
    ...
    public ResponseEntity<Map<String, Object>> getApprovalStatus(@PathVariable String caseId) {
        ...
        // Check if this dispute requires multi-level approval
        ...
        if (requiresMultiApproval) {
            ...
            response.put("level1Approval", level1);
            ...
            response.put("level2Approval", level2);
            ...
            response.put("level3Approval", level3);
        }
    ...
    public ResponseEntity<Map<String, String>> submitLevel1Decision(
        ...
        boolean success = approvalService.recordLevel1Decision(caseId, decision, notes, username);
    ...
    public ResponseEntity<Map<String, String>> submitLevel2Decision(
        ...
        boolean success = approvalService.recordLevel2Decision(caseId, decision, notes, username);
    ...
    public ResponseEntity<Map<String, String>> submitLevel3Decision(
        ...
        boolean success = approvalService.recordLevel3Decision(caseId, decision, notes, username);
